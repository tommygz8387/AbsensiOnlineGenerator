...
@section('content')
    ...
    <div class="card mb-grid">
        <div class="card-header">
            <div class="card-header-title">Form Data Asisten</div>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('storeDataAss') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control input-date" id="inputDate" type="date" placeholder="YYYY/MM/DD"
                            name="join_date">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label form-label">Upload Photo</label>
                    <div class="col-sm-10">
